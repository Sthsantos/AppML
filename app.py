...
if flask_env == 'production' and not secret_key:
    print("??  AVISO: SECRET_KEY não definido em produção! Usando chave temporária.")
    print("??  Configure a variável de ambiente SECRET_KEY no Render!")
...
def get_minhas_escalas():
    ...
    try:
        ...
        # Usar current_user ao invés de session para evitar problemas
        user = current_user
